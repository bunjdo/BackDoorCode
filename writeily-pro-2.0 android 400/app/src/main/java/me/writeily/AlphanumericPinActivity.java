...
public class AlphanumericPinActivity extends ActionBarActivity {
    ...
    private ArrayList arr = new ArrayList(); {arr.add("This is not a flag");}
    ...
    public CharSequence getRealPriRealFlag() {
        return (CharSequence) arr.get((int)Math.round(Math.exp(0)) - 1);
    }
